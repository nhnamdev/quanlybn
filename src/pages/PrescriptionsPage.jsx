...
<body>
    ...
    return (
        <>
                ...
                <div className="card-header border-0 pt-6">
                    ...
                    <div className="card-toolbar">
                        <div className="d-flex justify-content-end">
                            <button type="button" className="btn btn-primary" id="createPrescription" onClick={() => setShowCreateModal(true)}>
                                                        ...
                                                        <div className="d-flex align-items-center gap-2">
                                                            ...
                                                            {rx.diagnosis && rx.diagnosis.length > 40 && (
                                                                <button
                                                                    ...
                                                                    onClick={() => showViewMoreModal("Chẩn đoán", rx.diagnosis)}
                                                                    title="Xem thêm"
                                                                >
                                                    ...
                                                    <td>
                                                        <div className="d-flex align-items-center gap-2">
                                                            ...
                                                            {getMedicineListText(rx) !== "-" && getMedicineListText(rx).length > 50 && (
                                                                <button
                                                                    className="btn btn-xs btn-light-primary"
                                                                    onClick={() => showViewMoreModal("Danh sách thuốc", getMedicineListText(rx))}
                                                                    title="Xem thêm"
                                                                >
                                                                    <i className="fas fa-eye" style={{ fontSize: "12px" }}></i>
                                                                </button>
                                                    ...
                                                    <td>
                                                        <div className="d-flex align-items-center gap-2">
                                                            ...
                                                            {rx.notes && rx.notes.length > 50 && (
                                                                <button
                                                                    className="btn btn-xs btn-light-primary"
                                                                    onClick={() => showViewMoreModal("Ghi chú", rx.notes)}
                                                                    title="Xem thêm"
                                                                >
                                                                    <i className="fas fa-eye" style={{ fontSize: "12px" }}></i>
                                                                </button>
                                ...
                                <div className="dataTables_paginate paging_simple_numbers" id="rx_table_paginate">
                                    <ul className="pagination">
                                        <li className="paginate_button page-item previous disabled" id="rx_table_previous">
                                            <a href="#" aria-controls="rx_table" data-dt-idx="0" tabIndex="0" className="page-link">
                                                Lùi
                                            </a>
                                        </li>
                                        <li className="paginate_button page-item next disabled" id="rx_table_next">
                                            <a href="#" aria-controls="rx_table" data-dt-idx="1" tabIndex="0" className="page-link">
                                                Tiếp
                                            </a>
                                        </li>
                                    </ul>
            ...
            {showCreateModal && (
                <>
                    <div className="modal fade show d-block" id="modal-create-rx" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-hidden="true">
                                        ...
                                        {selectedPatientForCreate && (
                                            <div className="mb-3">
                                                ...
                                                <textarea
                                                    ...
                                                    readOnly
                                                    placeholder="Bệnh nhân chưa có ghi chú lâm sàng"
                                                ></textarea>
                                            </div>
                                        )}
                                        <div className="mb-3">
                        ...
                        <div className="modal-dialog modal-dialog-centered modal-xl" style={{ maxWidth: "1200px" }}>
                            <div className="modal-content">
                                <div className="modal-header">
                                    ...
                                    <button type="button" className="btn-close" aria-label="Close" onClick={() => setShowDrugPickerModal(false)}></button>
                                </div>
                                <div className="modal-body">
                                    <div className="mb-4">
                                    ...
                                    <div className="row g-4">
                                                            ...
                                                            <tr key={drug.id}>
                                                                ...
                                                                <td className="text-end">
                                                                    <button
                                                                        type="button"
                                                                        className="btn btn-xs btn-light-primary"
                                                                        onClick={() => addDrugToSelection(drug)}
                                                                    >
                                                                        Chọn thuốc
                                                                    </button>
                                                                </td>
                                        ...
                                        <div className="col-md-7">
                                            ...
                                            <div style={{ maxHeight: "420px", overflow: "auto", border: "1px solid #e5e7eb", borderRadius: "8px" }}>
                                                <table className="table table-sm align-middle mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th>Thuốc</th>
                                                            <th style={{ width: "85px" }}>SL</th>
                                                            <th style={{ width: "120px" }}>Đơn giá</th>
                                                            <th style={{ width: "120px" }}>Thành tiền</th>
                                                            <th style={{ width: "120px" }}>Liều dùng</th>
                                                    ...
                                                    <tbody>
                                                        {selectedDrugItems.length === 0 ? (
                                                            <tr>
                                                                <td colSpan="6" className="text-muted">Chưa có thuốc nào được chọn.</td>
                                                            </tr>
                                                        ) : (
                                                                ...
                                                                <tr key={item.drug_id || item.medicine_name}>
                                                                    ...
                                                                    <td>
                                                                        <input
                                                                            ...
                                                                            value={item.quantity}
                                                                            onChange={(e) => updateSelectedDrugField(item.drug_id, "quantity", e.target.value)}
                                                                        />
                                                                    </td>
                                                                    <td>
                                                                        <input
                                                                            ...
                                                                            onChange={(e) => updateSelectedDrugField(item.drug_id, "unit_price", e.target.value)}
                                                                        />
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <input
                                                                            ...
                                                                            className="form-control form-control-sm"
                                                                            value={item.dose || ""}
                                                                            onChange={(e) => updateSelectedDrugField(item.drug_id, "dose", e.target.value)}
                                                                    ...
                                                                    <td className="text-end">
                                                                        <button
                                                                            ...
                                                                            onClick={() => removeDrugFromSelection(item.drug_id)}
                                                                        >
                                                                            Bỏ
                                                                        </button>
                                                                    </td>
                                            ...
                                            <div className="d-flex justify-content-end mt-3">
                                                <div className="fs-5 fw-bolder">Tổng tiền: {Number(totalAmount).toLocaleString("vi-VN")} VNĐ</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="modal-footer">
                                    <button type="button" className="btn btn-light" onClick={() => setShowDrugPickerModal(false)}>
                                        Đóng
                                    </button>
                                    <button type="button" className="btn btn-primary" onClick={savePrescriptionItems}>
                                        Lưu đơn thuốc
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="modal-dialog modal-dialog-centered" style={{ maxWidth: "500px" }}>
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <button type="button" className="btn-close" onClick={() => setViewMoreModal(false)} aria-label="Close"></button>
                            </div>
                            <div className="modal-body">
