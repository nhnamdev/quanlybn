...
function PatientsPage() {
    ...
    return (
        <>
                ...
                <div className="card-header border-0 pt-6">
                    ...
                    <div className="card-toolbar">
                        <div className="d-flex justify-content-end">
                            <button type="button" className="btn btn-primary js-create-patient" id="createPatient" onClick={() => setShowCreateModal(true)}>
                    ...
                    <div id="patient_table_wrapper" className="dataTables_wrapper dt-bootstrap4 no-footer">
                                ...
                                <table id="patient_table" className="table align-middle table-striped table-row-dashed fs-5 g-1 align-middle dataTable no-footer dtr-inline" aria-describedby="patient_table_info">
                                    <thead>
                                        <tr className="text-start text-gray-900 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th style={{ width: "130px" }}>Ho va Ten</th>
                                            <th style={{ width: "80px" }}>Gioi tinh</th>
                        ...
                        <div className="row">
                            <div className="col-sm-12 col-md-5">
                                <div className="dataTables_info" id="patient_table_info" role="status" aria-live="polite">
            ...
            {showCreateModal && (
                <>
                    <div className="modal fade show d-block" id="modal_patient" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-hidden="true">
                                ...
                                <div className="modal-body">
                                    <form onSubmit={handleCreatePatient}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <select className="form-select" name="gender" value={formData.gender} onChange={onInputChange}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="date" className="form-control" name="dob" value={formData.dob} onChange={onInputChange} required />
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">So dien thoai</label>
                                            <input type="tel" className="form-control" name="phone_number" value={formData.phone_number} onChange={onInputChange} />
                                        </div>
                                        <div className="mb-3">
